                    ...
                    <div class="col-lg-8">
                        <div class="standard__blog__post">
                            <div class="standard__blog__thumb">
                                <img src="{{ asset('fronend/assets/img/blog/blog_thumb01.jpg') }}" alt="">
                            </div>
                            <div class="blog__details__content services__details__content">
                                ...
                                <p>Definition Business strategy can be understood as the course of action or set of
                                    decisions which assist the
                                    entrepreneurs in achieving specific business objectives.</p>
                                <p>It is nothing but a master plan that the management of a company implements to secure
                                    a competitive position in the market, carry on its operations, please customers and
                                    achieve the desired ends of the business.</p>
                                <p>In business, it is the long-range sketch of the desired image, direction and
                                    destination of the organization. It is a scheme of corporate intent and action,
                                    which is carefully planned and flexibly designed with the purpose of</p>
                                ...
                                <div class="services__details__img">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <img src="{{ asset('fronend/assets/img/blog/blog_details_img01.jpg') }}"
                                                alt="">
                                        </div>
                                        <div class="col-sm-6">
                                            <img src="{{ asset('fronend/assets/img/blog/blog_details_img02.jpg') }}"
                                                alt="">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <p>A business strategy is a combination of proactive actions on the part of management,
                                    ...
                                    and reactions to unexpected developments and new market.</p>
                                <p>The maximum part of the company’s present strategy is a result of formerly initiated
                                    ...
                                    turn, the company requires a strategic reaction to cope with contingencies. Hence,
                                    for unforeseen development, a part of the business strategy is formulated as a
                                            ...
                                            <div class="blog__next__prev__post">
                                                <div class="blog__next__prev__thumb">
                                                    <a href="blog-details.html"><img
                                                            src="{{ asset('fronend/assets/img/blog/blog_prev.jpg') }}"
                                                            alt=""></a>
                                                </div>
                                    ...
                                    <div class="col-xl-5 col-md-6">
                                        <div class="blog__next__prev__item next_post text-end">
                                            ...
                                            <div class="blog__next__prev__post">
                                                <div class="blog__next__prev__thumb">
                                                    <a href="blog-details.html"><img
                                                            src="{{ asset('fronend/assets/img/blog/blog_next.jpg') }}"
                                                            alt=""></a>
                                                </div>
                                                <div class="blog__next__prev__content">
                                ...
                                <ul class="comment__list">
                                    <li class="comment__item">
                                        <div class="comment__thumb">
                                            <img src="{{ asset('fronend/assets/img/blog/comment_thumb01.png') }}"
                                                alt="">
                                        </div>
                                    ...
                                    <li class="comment__item children">
                                        <div class="comment__thumb">
                                            <img src="{{ asset('fronend/assets/img/blog/comment_thumb02.png') }}"
                                                alt="">
                                        </div>
                                        <div class="comment__content">
                                            <div class="comment__avatar__info">
                                    ...
                                    <li class="comment__item">
                                        <div class="comment__thumb">
                                            <img src="{{ asset('fronend/assets/img/blog/comment_thumb03.png') }}"
                                                alt="">
                                        </div>
                                        <div class="comment__content">
                                            <div class="comment__avatar__info">
                                    ...
                                    <li class="comment__item children">
                                        <div class="comment__thumb">
                                            <img src="{{ asset('fronend/assets/img/blog/comment_thumb04.png') }}"
                                                alt="">
                                        </div>
                                        <div class="comment__content">
                                            <div class="comment__avatar__info">
